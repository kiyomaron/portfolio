    ...
    <section className='pt-100 pb-100'>
        <div className='container timeline'>
            ...
            <div>
                ...
                <p>私がエンジニアになろうと考えたきっかけは、セブの留学とオーストラリアのワーキングホリデーでした。学生時代、それまでサービス業に就きたいと考えていた私は、英語をペラペラにして日本で活躍しようと考え海外へ行きました。しかし、その間の経験や出会った人々と会話をしていく中で、英語はツールに過ぎないと気づきました。それプラスの専門スキルが必要だと気づき、卒業後の進路について考え直し、エンジニアというものを創り出す仕事に興味を持ち始めました。</p>
